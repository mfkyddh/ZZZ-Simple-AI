...
| 章节 | 标题 | 内容亮点 |
|:---:|:---|:---|
| 📖 **01** | **[什么是大模型](./docs/01-什么是大模型.md)** | 先搞懂 AI 最底层在做什么 |
| 📖 **02** | **[从聊天框到智能体](./docs/02-AI应用是怎样一步步发展到Agent的.md)** | AI 是怎么从"只能聊"进化到"能做事"的 |
| 📖 **03** | **[两条路线之争](./docs/03-两条路线之争：大模型派%20vs%20外部编排派.md)** | 大模型派 vs 驾驭工程派，谁在解决什么问题 |
| 📖 **04** | **[智能体到底怎么工作](./docs/04-智能体到底是怎么工作的.md)** | Agent 不是魔法，拆解给你看 |
| 📖 **05** | **[典型产品对比](./docs/05-把几个典型Agent产品放在一起看.md)** | Openclaw、龙虾、Cloud Code 放在一起看 |
| 📖 **06** | **[普通人怎么用好 AI](./docs/06-普通人怎么真正用好AI.md)** | 从认知到实践的落地建议 |
